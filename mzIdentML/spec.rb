...
describe 'PepXML2mzIdentML' do
    before do
        ...
        #@p2mo = Search2mzIdentML.new(PepXML.new("#{File.dirname($0)}/test-omssa.pep.xml", "#{File.dirname($0)}/../databases/ipi.HUMAN.v3.72.fasta"))
        #@p2mt = Search2mzIdentML.new(PepXML.new("#{File.dirname($0)}/test-tandem.pep.xml", "#{File.dirname($0)}/../databases/ipi.HUMAN.v3.72.fasta"))
    end
